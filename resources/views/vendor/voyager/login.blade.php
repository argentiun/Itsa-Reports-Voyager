                ...
                <div class="col-sm-12 col-md-10 col-md-offset-2">
                    <div class="logo-title-container">
                        ...
                        <div class="copy animated fadeIn">
                            <h1 style="font-size: 30px;">{{ Voyager::setting('admin.title', 'Voyager') }}</h1>
                            <p class="bienvenida">{{ Voyager::setting('admin.description', __('voyager::login.welcome')) }}</p>
                        </div>
            ...
            <div class="login-container">
                ...
                <form action="{{ route('voyager.login') }}" method="POST">
                    ...
                    <button type="submit" class="btn btn-block login-button">
                        <span class="signingin hidden"><span class="voyager"></span> Ingresando ...</span>
